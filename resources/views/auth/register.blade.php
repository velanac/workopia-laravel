<x-layout>
    <div class="bg-white rounded-lg shadow-md md:max-w-xl mx-auto mt-12 py-12 px-5">
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <button type="submit"
                class="w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded focus:outline">Register</button>
