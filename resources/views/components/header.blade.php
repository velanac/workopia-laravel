<header class="bg-blue-900 text-white p-4" x-data="{ open: false, toggle() { this.open = !this.open } }"">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <button id="hamburger" @click="toggle()" class="text-white md:hidden flex items-center">
