    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="company_website" name="company_website" placeholder='Company Website'
                label="Company Website" type="url" :value="old('company_website', $job->company_website)" />
            ...
            <x-inputs.text id="contact_email" name="contact_email"
                placeholder='Email where you want to receive applications' label="Contact Email" :value="old('contact_email', $job->contact_email)" />
